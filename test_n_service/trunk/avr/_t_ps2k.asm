...
; і                                             і
; і e   1 2 3 4 5 6 7 8 9 0 1 2  p s p  . . .   і07
; і                                             і
; і ` 1 2 3 4 5 6 7 8 9 0 - = <  i h u  n / * - і
; і t Q W E R T Y U I O P [ ] \  d e d  7 8 9   і
; і c A S D F G H J K L ; '   e         4 5 6 + і
; і s Z X C V B N M , . /     s        1 2 3   і
; і c w a       s       a w m c  <  >  0   . e і
; і                                             і
; іДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДі
; і Raw data:                                   і16
; і  00 00 00 00 00 00 00 00 00 00 00 00 00 00  і17
; і                                             і
; і ’асеЄа в­®Ґ ­ ¦ вЁҐ <ESC> - ўле®¤ Ё§ вҐбв   і19

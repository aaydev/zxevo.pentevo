...
void TMainZ80::retn()
{
//  nmi_in_progress = false;	//ЗАКОМЕНТИЛИ В NEDOREPO
//  set_banks();		//ЕСТЬ В 0.39.0
}
//=============================================================================
...
#endif
//=============================================================================
unsigned char membits[ 0x10000];		// для бряков и мемори бенда
//	MEMBITS_R = 0x01
//	MEMBITS_W = 0x02
//	MEMBITS_X = 0x04
//	MEMBITS_BPR = 0x10
...
//		2 FREE
//
// тк расширить ширину membits-ов несколько проблематично с точки зрения подводных граблей
// то для недостающего функционала еще буфера
unsigned char io_bits[ 0x10000];		// для IO [NS]
//	IO_BITS_IN
//	IO_BITS_OUT
//	IO_BITS_BP_IN
//	IO_BITS_BP_OUT
...
unsigned char bp_disable_bits[ 0x10000];	// для отключения бряков [NS]
//	BP_DISABLE_BPR
//	BP_DISABLE_BPW
//	BP_DISABLE_BPX
//
...
//=============================================================================
unsigned char needclr;			// clear screenbuffer before rendering (для дебагера)
//=============================================================================
HWND wnd;
HINSTANCE hIn;
//=============================================================================

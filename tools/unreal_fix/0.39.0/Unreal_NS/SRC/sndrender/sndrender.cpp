...
//-----------------------------------------------------------------------------
{
    ...
    mix_l = l;
    mix_r = r;	// это опять запись "отстает" ?
}
//=============================================================================
...
void SNDRENDER::flush(unsigned endtick)
{
    ...
    {   
	// Оптимизация, децимация не нужна,
	// т.к. после децимации tick совпадет с endtick
    ...
    //-------------------------------------------------------------------------
    // и оно трещит на saa1099 почамуто
    // или это код только для дижитала?
    if (conf.soundfilter)
    {
	...
	*/
    ...
    //-------------------------------------------------------------------------
    // значение громкости только в момент изменения ?
    #ifdef SND_EXTERNAL_BUFFER

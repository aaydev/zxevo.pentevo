...
HWND hwnd_bp_dialog = NULL;		// hwnd немодального окна бряков [NS]
HWND hwnd_watchdlg = NULL;		// hwnd немодального окна вачесов [NS]
...
//   SetErrorMode(SEM_FAILCRITICALERRORS | SEM_NOOPENFILEERRORBOX);	//нет строки в NEDOREPO
